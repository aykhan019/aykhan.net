...
function addAllMovies() {
    ...
    MOVIES.forEach(m => {
        if (m.Poster) {
            let content = `
            <section id='movie'>
                <div class="card mb-3 bg-light" style="max-width: 640px;">
                    <div class="row no-gutters">
                        <div class="col-md-6">
                            <img src='${m.Poster}' alt='${m.Title}' class="img-fluid mx-auto d-block">
                        </div>
                        <div class="col-md-6">
                            <div class="card-body">
                                <h5 class="card-title text-light id='movie-title'">${m.Title}</h5>
                                <p class="card-text text-light" id="movie-plot">${m.Plot}</p>
                            </div>
                            <button id="add-favorites-button">
                                Add To Favorites
                            </button>
                        </div>
                    </div>
...
function addFavorites(id) {
    // toggle the classes of the clicked element
